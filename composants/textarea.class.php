<?php
class SCF_Composant_Textarea extends SimpleCustomFields_Admin {
	 ...
	 */
	function SCF_Composant_Textarea(){
		...
		$this->fields = array( 
			...
			"regexp" => array( "name" => __('Regular expression', 'simple-custom-fields' ), "required" => false ),
							...
							<div class="inside">
								...
								<table class="form-table">
									<tbody>
										...
										<tr valign="top">
											<th scope="row"><label for="scf[default_value]"><?php _e('Default value', 'simple-custom-fields'); ?></label></th>
											<td><textarea rows="15" cols="34" name="scf[default_value]"><?php echo ( isset( $this->cleaned_fields['default_value'] ) && !empty( $this->cleaned_fields['default_value'] ) ) ? $this->cleaned_fields['default_value'] : ''; ?></textarea>
											<span class="description"></span></td>
										</tr>
										<tr valign="top">
	...
	?>
		<tr valign="top">
			...
			<td><textarea class="regular-text <?php echo $css_class  ?>" name="scf[<?php echo $field_slug; ?>]" rows="15" cols="34"><?php echo $field_value; ?></textarea>
