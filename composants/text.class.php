<?php
class SCF_Composant_Text extends SimpleCustomFields_Admin {
								...
								<table class="form-table">
									<tbody>
										...
										<tr valign="top">
											...
											<td><input name="scf[default_value]" type="text" value="<?php echo ( isset( $this->cleaned_fields['default_value'] ) && !empty( $this->cleaned_fields['default_value'] ) ) ? $this->cleaned_fields['default_value'] : ''; ?>" class="regular-text" />
											<span class="description"></span></td>
										</tr>
										<tr valign="top">
	...
	?>
		<tr valign="top">
			...
			<td>
				<input name="scf[<?php echo $field_slug; ?>]" type="text" class="regular-text <?php echo $css_class ; ?>" value="<?php echo $field_value; ?>" />
